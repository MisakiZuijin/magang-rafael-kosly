                    ...
                    @if($activeCount <= 2)
                        ...
                        <div class="p-3 bg-purple-50 dark:bg-purple-950/30 rounded-xl border border-purple-200 dark:border-purple-800/60 space-y-1.5">
                            ...
                            <p class="text-[11px] text-purple-700 dark:text-purple-300 leading-relaxed">
                                Teman sekamar Anda (<strong>{{ $roommateHalfName }}</strong>) telah membayar/mengunggah 50% tarif sewa kamar. Pilihan bayar full 1 kamar dinonaktifkan dan tagihan Anda disesuaikan menjadi <strong>50% (Tarif 1 Orang)</strong>.
                            </p>
                        </div>
                        @else
...
<form action="{{ route('penghuni.pembayaran.upload') }}" method="POST" enctype="multipart/form-data" class="space-y-3">
    ...
    @if($activeCount <= 2)
        ...
        <div class="p-3 bg-purple-50 dark:bg-purple-950/30 rounded-xl border border-purple-100 dark:border-purple-900/50 space-y-1.5">
            ...
            <p class="text-[11px] text-purple-700 dark:text-purple-300 leading-relaxed">
                Teman sekamar Anda (<strong>{{ $roommateHalfName }}</strong>) telah membayar/mengunggah 50% tarif sewa kamar. Opsi bayar full 1 kamar dinonaktifkan dan tagihan Anda disesuaikan menjadi <strong>50% (Tarif 1 Orang)</strong>.
            </p>
        </div>
        @else
