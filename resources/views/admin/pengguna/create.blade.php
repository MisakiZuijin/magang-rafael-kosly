...
<div class="space-y-4">
    <x-page-header 
        ...
        subtitle="Buat akun pengguna baru ({{ Auth::user()->role === 'super_admin' ? 'Admin, Mitra, atau Penghuni' : 'Mitra atau Penghuni' }})" 
        backUrl="{{ request()->is('superadmin*') ? route('superadmin.pengguna.index') : route('admin.pengguna.index') }}" 
    />
