    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
                Buat akun pengguna baru ({{ Auth::user()->role === 'super_admin' ? 'Admin, Mitra, atau Penghuni' : 'Mitra atau Penghuni' }})
            </p>
        </div>
        <x-btn href="{{ request()->is('superadmin*') ? route('superadmin.pengguna.index') : route('admin.pengguna.index') }}" variant="secondary" size="sm" class="!min-h-[36px] !py-1 text-xs">
            &larr; Kembali
        </x-btn>
    </div>
