...
@section('title', 'Peta Rute Terdekat - Super Admin')
...
}" id="superadmin-map-container">
    {{-- Header --}}
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-xl font-bold text-gray-900 dark:text-white leading-tight">Peta & Rute Terdekat</h1>
            <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Penentuan titik kantor (database) ke rute kos terdekat (Super Admin)</p>
            ...
            if (nearestItem) {
                ...
                try {
                    ...
                    if (data.code === 'Ok' && data.routes && data.routes.length > 0) {
                        ...
                        const el = document.getElementById('superadmin-map-container');
                        if (el && window.Alpine) {
