        ...
        <div x-show="matchSearch(@js($kan->nama . ' ' . ($kan->alamat ?? '')))"
            ...
            <div class="flex items-start justify-between gap-3">
                <div class="flex items-start gap-3 min-w-0">
                    <div class="w-10 h-10 bg-blue-50 dark:bg-blue-950/50 border border-blue-200/70 dark:border-blue-800/60 rounded-xl flex items-center justify-center text-blue-600 dark:text-blue-400 font-bold flex-shrink-0">
                    ...
                    <div class="min-w-0">
                        ...
                        <div class="flex flex-wrap items-center gap-2 mt-2 text-[11px]">
                            ...
                            <a href="{{ $kan->link_gmaps }}" target="_blank"
                                class="inline-flex items-center gap-1.5 px-2 py-0.5 bg-blue-50 dark:bg-blue-950/50 hover:bg-blue-100 dark:hover:bg-blue-900/60 border border-blue-200 dark:border-blue-800 font-semibold text-blue-700 dark:text-blue-300 rounded-md transition-all active:scale-95"
                            ...
                            @endif
                            @if($kan->no_telp)
                            <a href="tel:{{ $kan->no_telp }}"
                                class="inline-flex items-center gap-1.5 px-2 py-0.5 bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 border border-gray-200 dark:border-gray-700 font-semibold text-gray-700 dark:text-gray-300 rounded-md transition-all active:scale-95"
