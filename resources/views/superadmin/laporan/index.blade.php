...
<div class="space-y-4" x-data="{ tab: 'grafik' }">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Grafik kamar, aktivitas bayar, dan log per kos (Super Admin)</p>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-900 rounded-2xl p-4 border border-gray-200 dark:border-gray-800 shadow-sm space-y-2.5">
        ...
        <form action="{{ route('superadmin.laporan.filter') }}" method="GET" class="grid grid-cols-1 sm:grid-cols-3 gap-2">
            <div>
