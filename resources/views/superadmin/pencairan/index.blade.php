            ...
            <div x-show="matchSearch('{{ addslashes($kos->nama) }}', '{{ addslashes($mitra->nama ?? '') }}', '{{ $status }}')"
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div class="grid grid-cols-1 sm:grid-cols-4 col-span-2 min-w-0 space-y-1">
                        ...
                        <span class="col-span-1 w-max px-2.5 py-0.5 text-center text-xs font-bold uppercase rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 border border-gray-200 dark:border-gray-700">
