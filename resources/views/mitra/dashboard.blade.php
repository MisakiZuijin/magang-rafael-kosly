...
<div class="space-y-4" x-data="{ filterStatus: 'semua', selectedKosId: 'semua' }">
    ...
    <div class="flex items-center justify-between gap-2 pt-1">
        <h2 class="text-xs font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wider truncate min-w-0 flex items-center gap-1.5">
            ...
            <span>Daftar Properti &amp; Status Kamar</span>
        </h2>
                    ...
                    <div x-show="filterStatus === 'semua' || filterStatus === '{{ $kamar->status }}'"
                        ...
                        <div class="flex justify-between items-start gap-2 mb-2">
                            <div class="min-w-0 flex-1">
                                ...
                                <div class="flex items-center gap-2 text-[11px] font-mono font-bold text-gray-700 dark:text-gray-300 mt-1 flex-wrap">
                                    <span class="text-emerald-700 dark:text-emerald-300">Rp {{ number_format($kamar->harga_per_bulan, 0, ',', '.') }}/bln</span>
                                    @if($kamar->harga_per_minggu)
                                    <span class="text-purple-600 dark:text-purple-400">• Rp {{ number_format($kamar->harga_per_minggu, 0, ',', '.') }}/minggu</span>
                                    @endif
                                </div>
                            </div>
