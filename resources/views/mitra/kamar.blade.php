        ...
        <div x-show="
            ...
            <div class="grid gap-2 p-3 bg-white/60 dark:bg-gray-900/40 rounded-xl border border-gray-200/50 dark:border-gray-800">
                ...
                <div class="grid gap-1">
                    <p class="text-xs font-medium text-gray-700 dark:text-gray-300">Jenis Biaya</p>
                    <div class="grid grid-cols-[repeat(auto-fit,minmax(0,max-content))] items-center gap-2">
